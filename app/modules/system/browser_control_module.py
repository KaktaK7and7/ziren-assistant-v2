...
BROWSER_ACTIONS = {
    "new_tab": {
        ...
        "response": "Передала активному окну команду открыть новую вкладку.",
    },
    "close_tab": {
        "keys": ["ctrl", "w"],
        "triggers": ["закрой вкладку", "закрой текущую вкладку"],
        "response": "Передала активному окну команду закрыть текущую вкладку.",
    },
    "restore_tab": {
        "keys": ["ctrl", "shift", "t"],
        "triggers": ["верни вкладку", "восстанови вкладку", "верни закрытую вкладку"],
        "response": "Передала активному окну команду восстановить закрытую вкладку.",
    },
    "back": {
        "keys": ["alt", "left"],
        "triggers": ["назад в браузере", "вернись назад", "предыдущая страница"],
        "response": "Передала активному окну команду перейти назад.",
    },
    "forward": {
        "keys": ["alt", "right"],
        "triggers": ["вперед в браузере", "вперёд в браузере", "следующая страница"],
        "response": "Передала активному окну команду перейти вперёд.",
    },
    "reload": {
        "keys": ["ctrl", "r"],
        "triggers": ["обнови страницу", "перезагрузи страницу"],
        "response": "Передала активному окну команду обновить страницу.",
    },
    "address": {
        "keys": ["ctrl", "l"],
        "triggers": ["адресная строка", "перейди в адресную строку", "выдели адрес сайта"],
        "response": "Передала активному окну команду перейти в адресную строку.",
    },
    "next_tab": {
        "keys": ["ctrl", "tab"],
        "triggers": ["следующая вкладка", "переключи на следующую вкладку"],
        "response": "Передала активному окну команду переключиться на следующую вкладку.",
    },
    "previous_tab": {
        "keys": ["ctrl", "shift", "tab"],
        "triggers": ["предыдущая вкладка", "переключи на предыдущую вкладку"],
        "response": "Передала активному окну команду переключиться на предыдущую вкладку.",
    },
}
...
class SystemBrowserControlModule(AssistantModule):
    ...
    default_trigger_groups = {
        f"browser.{action_id}": {
            ...
            "argument_hint": (
                "Без аргументов. Действие отправляется активному окну как разрешённое "
                "сочетание клавиш. Пока Core не проверяет состояние браузера после hotkey, "
                "поэтому Ziren подтверждает только доставку команды Windows."
            ),
        }
